...
Copyright (c) 2026 gsakul21. All rights reserved.
Software: PropFinder
...
import and otherwise run, modify and propagate the contents of the software. This
patent license is limited to the software, and does not extend to any other
software that you combine with the software.
