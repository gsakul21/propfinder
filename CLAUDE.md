...
The section that outlines critical details regarding the project and gives important context. Fill and update accordingly as implementation changes.

# CLAUDE Self-Generated Guidelines

The section that holds all of CLAUDE's self-recognized instructions to improve output.
